            ...
            <div className="w-full sm:max-w-[900px] mx-auto sm:mb-0 flex justify-center">
              ...
              <div className="relative w-full sm:w-[850px]">     
                ...
                <img
                  ...
                  className="w-full h-auto object-contain -mt-10 sm:-mt-44" 
                />
              </div>
            </div>
            {/* Dynamic Bars Section */}
            <div className="flex flex-col sm:flex-row justify-center items-stretch gap-4 sm:gap-4 -mt-8 sm:-mt-44 w-full">
              <div className="w-full sm:w-96 rounded-xl p-6 shadow-md  bg-gradient-to-br from-gray-400 to-gray-700 mb-4 sm:mb-0 min-h-[260px]">
                {barsQ21.length > 0 ? (
                  barsQ21.map((bar, idx) => (
