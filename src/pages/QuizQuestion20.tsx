...
const QuizQuestion20 = () => {
  ...
  const options = [
    {
      ...
      icon: "/dummy-racing-thoughts-icon.png"
    },
    {
      id: "panic_attacks",
      text: "Panic attacks",
    ...
    },
    {
      id: "avoidance",
      text: "Avoidance",
      icon: "/dummy-avoidance-icon.png"
    },
    {
      id: "fear_rejection",
      text: "Fear of rejection",
      icon: "/dummy-rejection-icon.png"
    },
    {
      id: "low_self_esteem",
      text: "Low self-esteem",
      icon: "/dummy-esteem-icon.png"
    }
  ];
  ...
  const handleContinue = () => {
    setAnswer("question20", selectedOptions);
